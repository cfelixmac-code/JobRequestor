...
/* package */ final class Entry {
    ...
    /* package */
    synchronized long getLengthInBytes() {
    ...
    /* package */
    synchronized EditorOutputStream getCurrentEditorStream() {
        return mCurrentEditorStream;
    }

    /* package */
    synchronized void setCurrentEditorStream(EditorOutputStream currentEditorStream) {
    ...
    /* package */
    synchronized void markAsPublished(long newLength) {
